...
if (IsModuleInstalled("socialnetwork"))
{
	...
	COption::SetOptionString("wiki", "socnet_iblock_type_id", $IBLOCK_TYPE_ID, false);
	COption::SetOptionString("wiki", "socnet_iblock_id", $SOCNET_ID, false);
	COption::SetOptionString("wiki", "socnet_enable", 'Y', false);
	...
	if (IsModuleInstalled("forum"))
	{
		...
		COption::SetOptionString("wiki", "socnet_forum_id", $SOCNET_FORUM_ID, false);
		COption::SetOptionString("wiki", "socnet_use_review", "Y", false);
		COption::SetOptionString("wiki", "socnet_use_captcha", "Y", false);
		COption::SetOptionString("wiki", "socnet_message_per_page", 10, false);

	}
	else
	{
		COption::SetOptionString("wiki", "socnet_use_review", "N", false);
	}
}

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/wiki.php", $arReplaceParam);
...
if (WIZARD_INSTALL_DEMO_DATA || WIZARD_B24_TO_CP)
{
	\Bitrix\Main\UrlRewriter::add(
		WIZARD_SITE_ID,
		array(
			'CONDITION' => '#^' . WIZARD_SITE_DIR . 'services/wiki/#',
			'RULE' => '',
			'ID' => 'bitrix:wiki',
			'PATH' => WIZARD_SITE_DIR . 'services/wiki.php',
		)
	);
}
